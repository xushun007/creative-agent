...
```python
from creative_agent.core.compaction import CompactionManager, OpenCodeStrategy, CompactionContext
...
from creative_agent.core.compaction import CompactionManager, OpenCodeStrategy
...
class SessionWithCompaction(Session):
    ...
    def _estimate_current_tokens(self):
        """估算当前token数"""
        from creative_agent.core.compaction.utils import estimate_tokens, extract_message_text
...
```python
from creative_agent.core.compaction.base import CompactionStrategy
